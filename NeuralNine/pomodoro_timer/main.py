...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.root.tk.call('wm', 'iconphoto', self.root._w, PhotoImage(file='pomidor.png'))
        ...
        self.pomodoro_counter_label = ttk.Label(self.grid_layout, text='Pomodoros counter: 0', font=('Ubuntu', 16))
    ...
    def start_timer(self):
        ...
        if timer_id == 1:
            ...
            if not self.stopped or self.skipped:
                self.pomodoros += 1
                self.pomodoro_counter_label.config(text=f'Pomodoros counter: {self.pomodoros}')
    ...
    def reset_clock(self):
        ...
        self.pomodoro_counter_label.config(text='Pomodoros counter: 0')
        self.running = False
        self.tabs.select(0)
